    ...
    >
      ...
      <div className="flex items-center justify-center gap-2 px-6 py-5.5 lg:py-6.5">
        <p className="text-[2rem] font-semibold">
          <span className="text-white">E</span> - PERPUS
        </p>
        {/* <Link href="/">
          <Image
            width={176}
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === '/peminjaman' && 'text-white'
                              } `}
                            >
                              Peminjaman
                            </Link>
                          ...
                          <li>
                            <Link
                              href="/pengembalian"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === '/pengembalian' && 'text-white'
                              } `}
                            >
                              Pengembalian
                            </Link>
              ...
              <li>
                <Link
                  href="/anggota"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('anggota') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <li>
                <Link
                  href="/denda"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('denda') && 'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
                    className="fill-current"
